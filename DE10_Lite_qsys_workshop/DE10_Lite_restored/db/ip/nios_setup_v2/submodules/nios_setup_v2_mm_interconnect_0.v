...
module nios_setup_v2_mm_interconnect_0 (
	...
	wire         cmd_mux_008_src_valid;                                                     // cmd_mux_008:src_valid -> hex_2_s1_agent:cp_valid
	wire  [95:0] cmd_mux_008_src_data;                                                      // cmd_mux_008:src_data -> hex_2_s1_agent:cp_data
	wire         cmd_mux_008_src_ready;                                                     // hex_2_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire  [12:0] cmd_mux_008_src_channel;                                                   // cmd_mux_008:src_channel -> hex_2_s1_agent:cp_channel
	wire         cmd_mux_008_src_startofpacket;                                             // cmd_mux_008:src_startofpacket -> hex_2_s1_agent:cp_startofpacket
	wire         cmd_mux_008_src_endofpacket;                                               // cmd_mux_008:src_endofpacket -> hex_2_s1_agent:cp_endofpacket
	...
	wire  [12:0] cmd_mux_009_src_channel;                                                   // cmd_mux_009:src_channel -> hex_1_s1_agent:cp_channel
	...
	wire         cmd_mux_010_src_valid;                                                     // cmd_mux_010:src_valid -> hex_3_s1_agent:cp_valid
	wire  [95:0] cmd_mux_010_src_data;                                                      // cmd_mux_010:src_data -> hex_3_s1_agent:cp_data
	wire         cmd_mux_010_src_ready;                                                     // hex_3_s1_agent:cp_ready -> cmd_mux_010:src_ready
	wire  [12:0] cmd_mux_010_src_channel;                                                   // cmd_mux_010:src_channel -> hex_3_s1_agent:cp_channel
	wire         cmd_mux_010_src_startofpacket;                                             // cmd_mux_010:src_startofpacket -> hex_3_s1_agent:cp_startofpacket
	wire         cmd_mux_010_src_endofpacket;                                               // cmd_mux_010:src_endofpacket -> hex_3_s1_agent:cp_endofpacket
	...
	wire         cmd_mux_011_src_valid;                                                     // cmd_mux_011:src_valid -> hex_4_s1_agent:cp_valid
	wire  [95:0] cmd_mux_011_src_data;                                                      // cmd_mux_011:src_data -> hex_4_s1_agent:cp_data
	wire         cmd_mux_011_src_ready;                                                     // hex_4_s1_agent:cp_ready -> cmd_mux_011:src_ready
	wire  [12:0] cmd_mux_011_src_channel;                                                   // cmd_mux_011:src_channel -> hex_4_s1_agent:cp_channel
	wire         cmd_mux_011_src_startofpacket;                                             // cmd_mux_011:src_startofpacket -> hex_4_s1_agent:cp_startofpacket
	wire         cmd_mux_011_src_endofpacket;                                               // cmd_mux_011:src_endofpacket -> hex_4_s1_agent:cp_endofpacket
	...
	wire         cmd_mux_012_src_valid;                                                     // cmd_mux_012:src_valid -> hex_5_s1_agent:cp_valid
	wire  [95:0] cmd_mux_012_src_data;                                                      // cmd_mux_012:src_data -> hex_5_s1_agent:cp_data
	wire         cmd_mux_012_src_ready;                                                     // hex_5_s1_agent:cp_ready -> cmd_mux_012:src_ready
	wire  [12:0] cmd_mux_012_src_channel;                                                   // cmd_mux_012:src_channel -> hex_5_s1_agent:cp_channel
	wire         cmd_mux_012_src_startofpacket;                                             // cmd_mux_012:src_startofpacket -> hex_5_s1_agent:cp_startofpacket
	wire         cmd_mux_012_src_endofpacket;                                               // cmd_mux_012:src_endofpacket -> hex_5_s1_agent:cp_endofpacket
	...
	wire         hex_2_s1_agent_rp_valid;                                                   // hex_2_s1_agent:rp_valid -> router_010:sink_valid
	wire  [95:0] hex_2_s1_agent_rp_data;                                                    // hex_2_s1_agent:rp_data -> router_010:sink_data
	wire         hex_2_s1_agent_rp_ready;                                                   // router_010:sink_ready -> hex_2_s1_agent:rp_ready
	wire         hex_2_s1_agent_rp_startofpacket;                                           // hex_2_s1_agent:rp_startofpacket -> router_010:sink_startofpacket
	wire         hex_2_s1_agent_rp_endofpacket;                                             // hex_2_s1_agent:rp_endofpacket -> router_010:sink_endofpacket
	...
	wire         hex_3_s1_agent_rp_valid;                                                   // hex_3_s1_agent:rp_valid -> router_012:sink_valid
	wire  [95:0] hex_3_s1_agent_rp_data;                                                    // hex_3_s1_agent:rp_data -> router_012:sink_data
	wire         hex_3_s1_agent_rp_ready;                                                   // router_012:sink_ready -> hex_3_s1_agent:rp_ready
	wire         hex_3_s1_agent_rp_startofpacket;                                           // hex_3_s1_agent:rp_startofpacket -> router_012:sink_startofpacket
	wire         hex_3_s1_agent_rp_endofpacket;                                             // hex_3_s1_agent:rp_endofpacket -> router_012:sink_endofpacket
	...
	wire         hex_4_s1_agent_rp_valid;                                                   // hex_4_s1_agent:rp_valid -> router_013:sink_valid
	wire  [95:0] hex_4_s1_agent_rp_data;                                                    // hex_4_s1_agent:rp_data -> router_013:sink_data
	wire         hex_4_s1_agent_rp_ready;                                                   // router_013:sink_ready -> hex_4_s1_agent:rp_ready
	wire         hex_4_s1_agent_rp_startofpacket;                                           // hex_4_s1_agent:rp_startofpacket -> router_013:sink_startofpacket
	wire         hex_4_s1_agent_rp_endofpacket;                                             // hex_4_s1_agent:rp_endofpacket -> router_013:sink_endofpacket
	...
	wire         hex_5_s1_agent_rp_valid;                                                   // hex_5_s1_agent:rp_valid -> router_014:sink_valid
	wire  [95:0] hex_5_s1_agent_rp_data;                                                    // hex_5_s1_agent:rp_data -> router_014:sink_data
	wire         hex_5_s1_agent_rp_ready;                                                   // router_014:sink_ready -> hex_5_s1_agent:rp_ready
	wire         hex_5_s1_agent_rp_startofpacket;                                           // hex_5_s1_agent:rp_startofpacket -> router_014:sink_startofpacket
	wire         hex_5_s1_agent_rp_endofpacket;                                             // hex_5_s1_agent:rp_endofpacket -> router_014:sink_endofpacket
	...
	wire         hex_2_s1_agent_rdata_fifo_src_valid;                                       // hex_2_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_008:in_0_valid
	wire  [33:0] hex_2_s1_agent_rdata_fifo_src_data;                                        // hex_2_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_008:in_0_data
	wire         hex_2_s1_agent_rdata_fifo_src_ready;                                       // avalon_st_adapter_008:in_0_ready -> hex_2_s1_agent:rdata_fifo_src_ready
	...
	wire         hex_3_s1_agent_rdata_fifo_src_valid;                                       // hex_3_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_010:in_0_valid
	wire  [33:0] hex_3_s1_agent_rdata_fifo_src_data;                                        // hex_3_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_010:in_0_data
	wire         hex_3_s1_agent_rdata_fifo_src_ready;                                       // avalon_st_adapter_010:in_0_ready -> hex_3_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_010_out_0_valid;                                         // avalon_st_adapter_010:out_0_valid -> hex_3_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_010_out_0_data;                                          // avalon_st_adapter_010:out_0_data -> hex_3_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_010_out_0_ready;                                         // hex_3_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_010:out_0_ready
	wire   [0:0] avalon_st_adapter_010_out_0_error;                                         // avalon_st_adapter_010:out_0_error -> hex_3_s1_agent:rdata_fifo_sink_error
	wire         hex_4_s1_agent_rdata_fifo_src_valid;                                       // hex_4_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_011:in_0_valid
	wire  [33:0] hex_4_s1_agent_rdata_fifo_src_data;                                        // hex_4_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_011:in_0_data
	wire         hex_4_s1_agent_rdata_fifo_src_ready;                                       // avalon_st_adapter_011:in_0_ready -> hex_4_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_011_out_0_valid;                                         // avalon_st_adapter_011:out_0_valid -> hex_4_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_011_out_0_data;                                          // avalon_st_adapter_011:out_0_data -> hex_4_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_011_out_0_ready;                                         // hex_4_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_011:out_0_ready
	wire   [0:0] avalon_st_adapter_011_out_0_error;                                         // avalon_st_adapter_011:out_0_error -> hex_4_s1_agent:rdata_fifo_sink_error
	wire         hex_5_s1_agent_rdata_fifo_src_valid;                                       // hex_5_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_012:in_0_valid
	wire  [33:0] hex_5_s1_agent_rdata_fifo_src_data;                                        // hex_5_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_012:in_0_data
	wire         hex_5_s1_agent_rdata_fifo_src_ready;                                       // avalon_st_adapter_012:in_0_ready -> hex_5_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_012_out_0_valid;                                         // avalon_st_adapter_012:out_0_valid -> hex_5_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_012_out_0_data;                                          // avalon_st_adapter_012:out_0_data -> hex_5_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_012_out_0_ready;                                         // hex_5_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_012:out_0_ready
	wire   [0:0] avalon_st_adapter_012_out_0_error;                                         // avalon_st_adapter_012:out_0_error -> hex_5_s1_agent:rdata_fifo_sink_error
	...
	nios_setup_v2_mm_interconnect_0_router_002 router_014 (
